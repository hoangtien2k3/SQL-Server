...
VALUES
('001', N'Nguyễn', N'Thành', N'Nam', '2000-01-01', N'Hà Nội', 'KH', 15000.000),
('002', N'Phạm', N'Hương', N'Nữ', '2001-02-02', N'Hải Phòng', 'KT', 25000.000),
('003', N'Trần', N'Thịnh', N'Nam', '2002-03-03', N'Thái Bình', 'NN', 52000.000),
('004', N'Lê', N'Thảo', N'Nữ', '2003-04-04', N'Đà Nẵng', 'SP', 15000.000);
